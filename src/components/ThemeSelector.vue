    ...
    <div class="dropdown dropdown-end">
        ...
        <ul tabindex="0"
            ...
            <li v-for="theme in themes" :key="theme">
                <Button @click="changeTheme(theme)" variant="ghost" :class="[
                    'gap-3 px-2 w-full text-left',
                    ...
                    <svg v-if="currentTheme === theme" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        viewBox="0 0 24 24" fill="currentColor" class="h-3 w-3 shrink-0">
